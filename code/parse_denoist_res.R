...
denoist_counts <- lapply(res_files, function(tma){
  message(tma)
  res <- readRDS(paste0("/scratch/hnatri/DenoIST/GBMHGG_TMA_outputs/", tma))
...
#saveRDS(cell_seurat_data, "/tgen_labs/banovich/BCTCSF/13384_GBMHGG_Xenium/Seurat/spatial_clustered_NN30_PC50_Seurat_DenoIST.rds")
