...
seurat_data <- readRDS("/tgen_labs/banovich/BCTCSF/13384_GBMHGG_Xenium/Seurat/spatial_clustered_NN30_PC50_Seurat_denoIST.rds")
...
#            "/home/hnatri/PIPAC_spatial/proximity_compiled.tsv",
...
enrichment_scores_compiled <- read.table("/home/hnatri/13384_GBMHGG_SPP1_Xenium/enrichment_scores_compiled.tsv",
                                         header = T)
proximity_compiled <- read.table("/home/hnatri/13384_GBMHGG_SPP1_Xenium/proximity_compiled.tsv",
                                 header = T)
