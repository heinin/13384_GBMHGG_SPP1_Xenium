...
#source("/home/hnatri/13384_GBMHGG_SPP1_Xenium/code/PIPAC_colors_themes.R")
...
seurat_data <- readRDS("/tgen_labs/banovich/BCTCSF/13384_GBMHGG_Xenium/Seurat/immune_nonimmune_annotated_merged_Seurat.rds")

unique(seurat_data$prelim_annot)
...
# Using RANN
coords <- as.matrix(coords[ , c("x_centroid", "y_centroid")])
...
sample_niches <- lapply(samples, function(sample){
  ...
  coords <- seurat_subset@meta.data[, c("x_centroid", "y_centroid")]
...
saveRDS(seurat_with_niches, "/tgen_labs/banovich/BCTCSF/13384_GBMHGG_Xenium/Seurat/immune_nonimmune_annotated_merged_Seurat_niches.rds")
