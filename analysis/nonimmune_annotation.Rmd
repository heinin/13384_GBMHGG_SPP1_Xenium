...
```{r, message = F, warning = F, fig.width = 8, fig.height = 26, eval = T}

seurat_data$prelim_annot <- mapvalues(seurat_data$leiden_1.5,
                                      from = nonimmune_annot$leiden_1.5,
                                      to = nonimmune_annot$annotation)

unique(seurat_data$prelim_annot)

saveRDS(seurat_data, "/tgen_labs/banovich/BCTCSF/13384_GBMHGG_Xenium/Seurat/nonimmune_clustered_NN30_PC20_Seurat.rds")
