---
title: "Immune celltype annotation on GBM/HGG Xenium data"
author: "heinin"
date: "2025-10-11"
output:
...
seurat_data <- readRDS("/tgen_labs/banovich/BCTCSF/13384_GBMHGG_Xenium/Seurat/immune_clustered_NN30_PC20_Seurat.rds")
...
write.table(output_cluster_markers, "/home/hnatri/13384_GBMHGG_SPP1_Xenium/immune_top_markers.tsv",
...
create_dotplot_heatmap(seurat_object = seurat_data,
                       ...
                       group_colors = immune_cluster_col,
                       column_title = "",
                       row_km = 5,
                       col_km = 5,
                       row.order = NULL,
...
seurat_data$prelim_annot <- mapvalues(seurat_data$leiden_1.5,
                                      ...
                                      to = immune_annot$annotation)

unique(seurat_data$prelim_annot)

saveRDS(seurat_data, "/tgen_labs/banovich/BCTCSF/13384_GBMHGG_Xenium/Seurat/immune_clustered_NN30_PC20_Seurat.rds")
