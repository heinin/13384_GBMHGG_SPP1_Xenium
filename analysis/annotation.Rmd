---
title: "First pass cßelltype annotation on GBM/HGG Xenium data"
author: "heinin"
date: "2025-10-11"
output:
...
```{r, message = F, warning = F, fig.width = 6, fig.height = 18, eval = T}
...
seurat_data$Lineage <- ifelse(seurat_data$leiden_1.0 %in% c(0, 1, 4, 8),
                              "Immune", "TumorStroma")
...
# To build on command line, run Rscript -e "rmarkdown::render('annotation.Rmd')"
